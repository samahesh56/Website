...
export default function TransitionSection() {
  ...
  const skillCards = [
    ...
    },
    {
      ...
      tags: ['Data Analytics', 'Technical Writing', 'Hardware Literacy', 'Corporate Outreach'],
    },
    {
      icon: '🤖',
      title: 'Machine Learning & Research',
      description: 'Active member of ML Club and Penn State ACM, with research mentoring experience',
