...
export default function TransitionSection() {
  ...
  const skillCards = [
    {
      ...
      description:
        'Full-stack development experience with multiple languages and tools',
    ...
    },
    {
      ...
      description:
        'Experience in data analysis, technical documentation, and corporate outreach',
      tags: [
        'Data Analytics',
        'Technical Writing',
        'Hardware Literacy',
    ...
    },
    {
      ...
      description:
        'Active member of ML Club and Penn State ACM, with research mentoring experience',
      tags: ['Machine Learning', 'PyTorch (In Progress)', 'ACM'],
    },
  ];
  ...
  return (
    <section
      ref={sectionRef}
      className="relative pt-16 pb-32 bg-gradient-to-b from-slate-800 to-slate-900"
    >
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-8">
            {skillCards.map(
              (
                card,
                index // Technical Proficiency section
              ) => (
                <motion.div
                  key={card.title}
